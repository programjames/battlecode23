...
public final class Pather {
    ...
    public static boolean[] checked = new boolean[121]; // have we checked this location in our Dijkstra?
    ...
    static {
        for (int dy = -5; dy < 1 + 5; dy++) {
            for (int dx = -5; dx < 1 + 5; dx++) {
